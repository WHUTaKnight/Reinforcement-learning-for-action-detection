...
parser.add_argument("--frame_path", type=str, default='/mnt/SSD/ActivityNet/anet_v1.3_extracted_340/')
...
if args.dataset == 'activitynet':
    ...
    db.try_load_file_path('/mnt/SSD/ActivityNet/anet_v1.3_extracted_340/')
